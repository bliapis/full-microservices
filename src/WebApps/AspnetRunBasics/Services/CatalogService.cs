...
namespace AspnetRunBasics.Services
{
    public class CatalogService : ICatalogService
    {
        ...
        {
            _logger.LogError("Teste Log {customErrorLogKey}", 9);
            _logger.LogInformation("Getting catalog data from url: {url} and custom property : {customProperty}", _client.BaseAddress, 11);
